...
$$
-z(\alpha/2) \le \cfrac{\hat{p} - p}{\sqrt{p(1-p)/n}} \le z(\alpha/2)
\tag{1.4}
$$
...
$$
\hat{p} - z(\alpha/2) \sqrt{\cfrac{p(1-p)}{n}}
\le p \le
\hat{p} + z(\alpha/2) \sqrt{\cfrac{p(1-p)}{n}}
$$
...
$$
\hat{p} - z(\alpha/2) \sqrt{\cfrac{\hat{p}(1-\hat{p})}{n}}
\le p \le
\hat{p} + z(\alpha/2) \sqrt{\cfrac{\hat{p}(1-\hat{p})}{n}}
\tag{1.5}
$$
...
> 
> ![二項分布](https://user-images.githubusercontent.com/13412823/212012103-71c759ed-4bbd-423b-9260-6011ae86591d.png)
