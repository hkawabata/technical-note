...
この計算フローには
- いずれのステップにおいても、2つの DFT の結果から、次ステップで使う新しい2つの DFT を計算
