...
| 読み | 記法 | 表示 | 読み | 記法 | 表示 |
| :---: | :---: | :---: | :---: | :---: | :---: |
| アルファ | `\alpha` | $$\alpha$$ | ニュー | `\nu` | $$\nu$$ |
| ベータ | `\beta` | $$\beta$$ | グザイ | `\xi`, `\Xi` | $$\xi$$, $$\Xi$$ |
| ガンマ | `\gamma`, `\Gamma` | $$\gamma$$, $$\Gamma$$ | オミクロン | `o` | $$o$$ |
| デルタ | `\delta`, `\Delta` | $$\delta$$, $$\Delta$$ | パイ | `\pi`, `\Pi` | $$\pi$$, $$\Pi$$ |
| イプシロン | `\epsilon`, `\varepsilon` | $$\epsilon$$, $$\varepsilon$$ | ロー | `\rho`, `\varrho` | $$\rho$$, $$\varrho$$ |
| ゼータ | `\zeta` | $$\zeta$$ | シグマ | `\sigma`, `\Sigma` | $$\sigma$$, $$\Sigma$$ |
| イータ | `\eta` | $$\eta$$ | タウ | `\tau` | $$\tau$$ |
| シータ | `\theta`, `\Theta` | $$\theta$$, $$\Theta$$ | ウプシロン | `\upsilon`, `\Upsilon` | $$\upsilon$$, $$\Upsilon$$ |
| イオタ | `\iota` | $$\iota$$ | ファイ | `\phi`, `\Phi` | $$\phi$$, $$\Phi$$ |
| カッパ | `\kappa` | $$\kappa$$ | カイ | `\chi` | $$\chi$$ |
